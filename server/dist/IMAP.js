...
class Worker {
    ...
    connectToServer() {
        return __awaiter(this, void 0, void 0, function* () {
            const client = new ImapClient.default(this.serverInfo.imap.host, this.serverInfo.imap.port, { auth: this.serverInfo.imap.auth });
    ...
    listMailboxes() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield client.close();
            const finalMailboxes = []; // constant array can be pushed too
